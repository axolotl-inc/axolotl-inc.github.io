...
var drawUum = function(x, y) {
    ...
    ctxOTHER.beginPath();
    ctxOTHER.ellipse(x, y + canvas.width / 19 / 2, canvas.width / 19 / 1.3, canvas.width / 19 / 1.92, 0, 0, 2 * Math.PI, false);
    ctxOTHER.fill();


    //eyes:
    circle(x - canvas.width / 95, y - canvas.width / 19 / 4, canvas.width / 125.4, true, "black", "black");
    circle(x + canvas.width / 95, y - canvas.width / 19 / 4, canvas.width / 125.4, true, "black", "black");
};
...
var drawDig = function(X, y) {
    ...
    //eyes:
    circle(x - canvas.width / 75, y - canvas.width / 60, canvas.width / 125.4, true, "black", "black");
    circle(x + canvas.width / 75, y - canvas.width / 60, canvas.width / 125.4, true, "black", "black");

    //snoot:
    ctxOTHER.fillStyle = 'white';
    ctxOTHER.beginPath();
    ctxOTHER.ellipse(x, y, canvas.width / 80, canvas.width / 120, 0, 0, Math.PI * 2, false);
    ctxOTHER.fill();
    ...
    //ears:
    circle(x - (canvas.width / 28), y - (canvas.width / 22), canvas.width / 62.7, true, 'Chocolate', false);
    circle(x + (canvas.width / 28), y - (canvas.width / 22), canvas.width / 62.7, true, 'Chocolate', false);
};
...
var drawIll = function(x, y) {
    ...
    //uurs:
    circle(x - (canvas.width / 28), y - (canvas.width / 22), canvas.width / 62.7, true, 'pink', false);
    circle(x + (canvas.width / 28), y - (canvas.width / 22), canvas.width / 62.7, true, 'pink', false);
    circle(x - (canvas.width / 28), y - (canvas.width / 22), canvas.width / 62.7, false, 'silver', 'silver');
    circle(x + (canvas.width / 28), y - (canvas.width / 22), canvas.width / 62.7, false, 'silver', 'silver');

    //snootle:
    ctxOTHER.fillStyle = 'white';
    ctxOTHER.beginPath();
    ctxOTHER.ellipse(x, y - canvas.height / 48, canvas.width / 120, canvas.width / 180, 0, 0, Math.PI * 2, false);
    ctxOTHER.fill();

    //uus:
    circle(x - canvas.width / 60, y - canvas.width / 60, canvas.width / 140, true, "black", "black");
    circle(x + canvas.width / 60, y - canvas.width / 60, canvas.width / 140, true, "black", "black");
...
var drawCod = function(x, y) {
    ...
    ctxOTHER.beginPath();
    ctxOTHER.arc(x - canvas.width / 60, y - canvas.width / 60, canvas.width / 140, 0, Math.PI, true);
    ...
    ctxOTHER.quadraticCurveTo(x + canvas.width / 19, y + canvas.width / 19, x + canvas.width / 19, y);
    ctxOTHER.fill();
    ...
    ctxOTHER.beginPath();
    ctxOTHER.moveTo(x + canvas.width / 40, y - canvas.width / 60);
    ctxOTHER.lineTo((x + canvas.width / 40) + canvas.width / 120, canvas.width / 120);
    ctxOTHER.fill();
};
...
var testCollide = function() {
    ...
    var mazeData = ctx.getImageData(x - uumBoxWidth / 2, y - uumBoxHeight / 2, uumBoxWidth, uumBoxHeight).data;
    var uumData = ctxOTHER.getImageData(x - uumBoxWidth / 2, y - uumBoxHeight / 2, uumBoxWidth, uumBoxHeight).data;

    for (var pix = 0; pix < uumBoxWidth * uumBoxHeight; pix++) {
        var isInUum = uumData[4 * pix + 3] > 0; // alpha of Uum canvas is > 0;
        if (isInUum && !(mazeData[4 * pix] === 255 && mazeData[4 * pix + 1] === 255 && mazeData[4 * pix + 2] === 0)) {
            level = 1;
            x = canvas.width / 2;
...
var drawMazeBorders = function() {
    ...
    ctx.fillStyle = 'blue';
    if (level == 1) {
        ctx.fillRect((canvas.width / 2) / 2, (canvas.height / 2) - ((canvas.height / 2) / 2), mazeWidth(), (canvas.height / 2) + ((canvas.height / 2) / 2));
        ...
        ctx.fillRect(canvas.width / 2, (((canvas.height / 2) / 2) / 2) * 7.5, canvas.width, canvas.height);
        ctx.fillRect((((canvas.width / 2) / 2) / 2) * 7.5, 0, canvas.width, canvas.height);
    }

    //for level 2:
    ctx.fillStyle = 'green';
    if (level == 2) {
        ctx.fillRect((canvas.width / 2) / 2, canvas.height / 2, mazeWidth(), (canvas.height / 2) + ((canvas.height / 2) / 2));
        ctx.fillRect((canvas.width / 2) + ((canvas.width / 2) / 2), canvas.height / 2, mazeWidth(), canvas.height);
        ctx.fillRect(0, canvas.height / 2, canvas.width / 4 + 5, mazeWidth());
        ctx.fillRect((canvas.width / 2) + (((canvas.width / 2) / 2) / 2), canvas.height / 2, canvas.width / 2, mazeWidth());
        ctx.fillRect(0, 0, mazeWidth(), canvas.height / 2);
    ...
    ctx.fillStyle = 'red';
    if (level == 3) {
        ctx.fillRect((canvas.width / 2) / 2, (canvas.height / 2) * 1.4, canvas.width, mazeWidth());
        ctx.fillRect(0, (canvas.height / 2) - ((canvas.height / 2) / 2), (canvas.width / 2) + ((canvas.width / 2) / 2), mazeWidth());
    ...
    if (level == 4) {
        ...
        ctx.fillRect(finnalXOther, (canvas.height / 2) - ((canvas.height / 2) / 2), (canvas.width / 2) / 2, mazeWidth());
    ...
    ctx.fillStyle = 'green';
    if (level == 6) {
        ctx.fillRect(0, (canvas.height / 2) + (((canvas.height / 2) / 2) / 2), (canvas.width / 2) / 2, canvas.height);
        ctx.fillRect(0, 0, canvas.width, mazeWidth());
        ctx.fillRect(canvas.width / 2, 0, canvas.width, canvas.height);
        ctx.fillStyle = 'yellow';
        ctx.fillRect(canvas.width / 2 - 5, canvas.height / 4, canvas.width, canvas.height / 4)
        ctx.fillRect((canvas.width / 2) + ((canvas.width / 2) / 2), 0, canvas.width, canvas.height);
    }

    //for level 7:
    ctx.fillStyle = 'blue';
    if (level == 7) {
        ctx.fillRect(canvas.width / 2, (canvas.height / 2) + (canvas.height / 8), canvas.width, mazeWidth() * 2);
...
var debug = function() {
    if (showDebug) {
        document.getElementById("moreInfo").textContent =
            `XY= ${ x }, ${ y }\nspeed=${ speed }\nimg: ` + ctx.getImageData(x, y, 1, 1).data.join(", ")
    }
    else {
        document.getElementById("moreInfo").textContent = "";
    }
...
var drawStuv = function() {
    if (stuv == 'uum') { drawUum(x, y) }
    if (stuv == 'dig') { drawDig(x, y) }
    if (stuv == 'cod') { drawCod(x, y) }
    if (stuv == 'ill') { drawIll(x, y) }
    if (stuv == 'pog') { drawPog(x, y) }
}
...
var mainLoop = setInterval(function() {
    ...
    if (level == 4 && stuv != 'pog') { speed = 7 }
    else if (level == 5 && stuv != 'pog') { speed = 13 }
